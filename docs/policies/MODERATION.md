...
4. **Focus on behavior**: Not identity or affiliation
...
- Not consensus-building (see `GOVERNANCE.md`)
...
- Low-effort posts ("What do you think about everything?")
...
- Serious violations addressed

But remember: **Decisions you don't like ≠ moderator misbehavior**
...
Changes will be documented and announced.

---

## Current Moderators

See repository settings or `GOVERNANCE.md` for current maintainer list.
